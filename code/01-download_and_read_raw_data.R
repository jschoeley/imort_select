#########################################################
# DOWNLOAD AND READ DATA ON US BIRTHS AND INFANT DEATHS #
#########################################################

# (1) Download data on US births and infant deaths from the web,
...
# path to save data
infant_path = "./priv/data/00-raw/nchs-us_cohort_linked_infant_deaths_births/"
# path to codebooks
infant_cbook_path = "./code/codebook-us_cohort_linked_infant_deaths_births.yaml"

# Functions to read the custom codebook -----------------------------------
...
# read, specify and save data on births and infant deaths
ideath <- ReadFromZip(infant_cbook, infant_path)
save(ideath, file = "./priv/data/01-pre_harmonized/us_ideath_1995-2010.RData")
