...
author:
#  - 'Jonas Schöley^[Max Planck Institute for Demographic Research. Correspondence: <schoeley@demogr.mpg.de>. During the writing of this article the author was supported by the University of Southern Denmark and funded by a grant from AXA Insurance.]'
output:
  bookdown::pdf_book:
     template: draft.tex
